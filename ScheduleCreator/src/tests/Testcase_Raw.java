 ...
 */
public class Testcase_Raw implements FlexRayTester
{
...
//			FlexRayConstants.STATIC_SLOT_LEN_BIT/8, FlexRayConstants.STATIC_SLOTS_PER_CYCLE);
	...
	public Testcase_Raw(String testCaseFile, FileFormat fileFormat, ReductionMode reductionMode)
	{
		...
		try
		{
			setMsgs(flexRay.FlexRayFileInput.ReadFile(new File("").getAbsolutePath().concat("/../ScheduleCreator/testcases/"+testCaseFile+".txt"), fileFormat, reductionMode));
