...
import scheduling.ILP.SchedulerILPFl21;
import support.Log;
import tests.FlexRayTester;
import tests.ScheduleCreatorConfig;
import tests.paper.periods.Testcase;
...
//		Log.logLowln("program finished", module);
		...
		for (int j = 1; j <= 100; j++)
		{
			...
			String path = "";
			testsToRun.add(new Testcase("Test"+j+"_Periods1", FileFormat.MULTI_MODE, ReductionMode.CONVENTIONAL,path));
			testsToRun.add(new Testcase("Test"+j+"_Periods_Original", FileFormat.MULTI_MODE, ReductionMode.CONVENTIONAL,path));
			testsToRun.add(new Testcase("Test"+j+"_Periods2", FileFormat.MULTI_MODE, ReductionMode.CONVENTIONAL,path));
			testsToRun.add(new Testcase("Test"+j+"_Periods3", FileFormat.MULTI_MODE, ReductionMode.CONVENTIONAL,path));
			testsToRun.add(new Testcase("Test"+j+"_Periods4", FileFormat.MULTI_MODE, ReductionMode.CONVENTIONAL,path));
			testsToRun.add(new Testcase("Test"+j+"_Periods5", FileFormat.MULTI_MODE, ReductionMode.CONVENTIONAL,path));
			testsToRun.add(new Testcase("Test"+j+"_Periods6", FileFormat.MULTI_MODE, ReductionMode.CONVENTIONAL,path));
